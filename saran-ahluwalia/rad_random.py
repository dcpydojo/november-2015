...
# Python script that generates [smaller] corpus which resembles the original; 
# sometimes with some pretty interestingside-effects. 

#Orginally based off of Bruce Ellis's awesome work @ Bell Labs 
...
# 	print "To run, type: rad_random.run()"
# 	print "To reload after changes to the source, type: reload(rad_random)"
